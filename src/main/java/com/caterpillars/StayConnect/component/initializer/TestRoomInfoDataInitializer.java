...
public class TestRoomInfoDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        Accommodation acc2 = accommodationRepository.findByNameAndAddress("Test Mountain Retreat","대구광역시 동구 동부로22길 24")
                .orElseThrow(() -> new IllegalArgumentException("Accommodation not found"));
        Accommodation acc3 = accommodationRepository.findByNameAndAddress("Test Beachside Bungalow","경상북도 구미시 인동36길 14-4 (진평동)")
                .orElseThrow(() -> new IllegalArgumentException("Accommodation not found"));
