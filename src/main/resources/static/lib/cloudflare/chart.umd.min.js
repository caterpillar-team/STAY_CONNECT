!(function (t, e) {
   ...
   function Ee(t, e, i, s) {
      let a = ((s = s || {}).data = s.data || {}),
         ...
         o =
            (s.font !== e && ((a = s.data = {}), (n = s.garbageCollect = []), (s.font = e)), t.save(), (t.font = e), 0);
      var r = i.length;
      let l, h, c, d, u;
      for (l = 0; l < r; l++)
         if (null == (d = i[l]) || O(d)) {
         ...
         !0 === n
            ...
            : (function (t, e, i, s) {
                 ...
                 for (o = e + 1; o <= i; ++o) {
                    ...
                    i.skip || i.stop
                       ? l.skip ||
                         ((s = !1), n.push({ start: e % a, end: (o - 1) % a, loop: s }), (e = r = i.stop ? o : null))
                       : ((r = o), l.skip && (e = o)),
                       (l = i);
                 }
   ...
   class zs extends e {
            ...
            if (
               ...
               if (O(d))
                  for (h = 0, c = d.length; h < c; ++h)
                     P((x = d[h])) || O(x) || ((m = Le(s, f.data, f.gc, m, x)), (b += p));
      ...
      _computeGridLineItems(t) {
         ...
         if ('top' === o) (m = e(this.bottom)), (y = this.bottom - d), (w = m - p), (S = e(t.top) + p), (D = t.bottom);
            ...
            (m = e(this.top)), (S = t.top), (D = e(t.bottom) - p), (y = m + p), (w = this.top + d);
         else if ('left' === o)
   ...
   var ba = Object.freeze({
      ...
      BarController: class extends Os {
         ...
         parseObjectData(t, e, i, s) {
            ...
            let d, u, g, f;
            for (u = (d = i) + s; d < u; ++d)
               (f = e[d]), ((g = {})[a.axis] = a.parse(m(f, l), d)), c.push(ca(m(f, h), g, n, d));
            return c;
         }
         updateRangeFromParsed(t, e, i, s) {
            ...
            for (let t = i; t < i + s; t++) {
               ...
               (function (n, t, e, i) {
                  ...
                  'middle' === s &&
                     ...
                     (s = (e._top || 0) === i ? l : (e._bottom || 0) === i ? h : ((a[ga(h, t, o, r)] = !0), l))),
                     (a[ga(s, t, o, r)] = !0),
                     (n.borderSkipped = a);
               })(x, g, b, o),
         ...
         _calculateBarValuePixels(t) {
            ...
            f !== u && ((g = f - u), (f = u)),
               h &&
                  ((u = l.barStart), (f = l.barEnd - l.barStart), 0 !== u && y(u) !== y(l.barEnd) && (g = 0), (g += u));
            var p,
               m,
               b = P(a) || h ? g : a;
      ...
      ScatterController: class extends Os {
         ...
         update(t) {
            ...
            if (
               ((this._drawStart = a), (this._drawCount = n), At(e) && ((a = 0), (n = i.length)), this.options.showLine)
            ) {
      ...
      buildTicks() {
         ...
         const s = (function (t, e) {
            ...
            for (
               m &&
               (d && y !== n
                  ? (i.push({ value: n }), y < n && S++, at(Math.round((y + S * k) * _) / _, n, za(n, v, t)) && S++)
                  : y < n && S++);
               S < w;
               ++S
            ) {
      ...
      determineDataLimits() {
         ...
         (this.min = p(t) ? Math.max(0, t) : null),
            ...
            this._zero &&
               ...
               !p(this._userMin) &&
               (this.min = t === Wa(this.min, 0) ? Wa(this.min, -1) : Wa(this.min, 0)),
   ...
   var an = Object.freeze({
      ...
      TimeSeriesScale: class extends en {
         ...
         _getTimestampsForTable() {
            ...
            return (
               (t = e.length && i.length ? this.normalize(e.concat(i)) : e.length ? e : i), (t = this._cache.all = t)
            );
         }
         getDecimalForValue(t) {
   ...
   function hn(n) {
      ...
      return (t, e) => {
         ...
         e instanceof pa
            ? (o = ((s = t), (a = o), (s.backgroundColor = s.data.map(() => rn(a++))), a))
            : e instanceof ma
            ? (o = ((s = t), (i = o), (s.backgroundColor = s.data.map(() => ln(i++))), i))
            : e && (o = ((e = t), (t = o), (e.borderColor = rn(t)), (e.backgroundColor = ln(t)), ++t));
      };
   }
   function cn(t) {
      let e;
      ...
      beforeLayout(t, e, i) {
         if (i.enabled) {
            const {
               ...
               n = a['elements'];
            (!i.forceOverride && (cn(s) || (a && (a.borderColor || a.backgroundColor)) || (n && cn(n)))) ||
               ((i = hn(t)), s.forEach(i));
         }
      },
   };
      ...
      getContext() {
         return (
            ...
            (this.$context =
               ...
               Pi(t, { tooltip: this, tooltipItems: this._tooltipItems, type: 'tooltip' })))
         );
         var t;
      }
      getTitle(t, e) {
         ...
         return (
            'center' === a
               ? ((p = h + c / 2),
                 ...
                 (g = d))
               : ((u =
                    'left' === s ? t + Math.max(n, r) + i : 'right' === s ? t + e - Math.max(o, l) - i : this.caretX),
                 (g =
                    'top' === a
                       ? ((f = h), (p = f - i), (d = u - i), u + i)
